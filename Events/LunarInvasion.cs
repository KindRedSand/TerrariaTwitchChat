...
{
    public class LunarInvasion : IWorldEvent
    {
        ...
        /// <summary>
        /// We use <see cref="IWorldEvent.InvasionList"/> instead this line couse <see cref="IWorldEvent.Type"/> selected as <see cref="InvasionType.Invasion"/>
        /// </summary>
        ...
        public override bool DisableOthers => Main.invasionProgressWave != 5 ? true : false;
        ...
        public override IDictionary<int, float> InvadersDrop
        {
            get
            {
                ...
                else return new Dictionary<int, float>()
                {
                    [ItemID.FragmentVortex] = 0.2f,
                    [ItemID.FragmentSolar] = 0.2f,
                    [ItemID.FragmentStardust] = 0.2f,
        ...
        {            
            ...
            switch (Main.invasionProgressWave)
            {
                ...
                case 5:
                    ...
                    TwitchChat.Post("Impeting doom aproach...", Color.PaleGreen);
                    EventPlayer.LunarSky = LunarSkies.None;
                    if (Main.netMode != 1)
                    {
