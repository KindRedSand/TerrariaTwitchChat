    ...
    public abstract class WorldEvent
    {
        ...
        internal void EventStart(EventWorld world, TwitchChat mod)
        {
            ...
            if (Main.netMode != 1) //If we NOT the server client
            {
                ...
                {
                    if (InvasionList != null && InvasionList.Count != 0) GlobalSpawnOverride.OverridePool(GetListForCurWave, DisableOthers, true);
                }
            ...
            if (Main.netMode == 2)
            {
                ...
                if (Type == InvasionType.Invasion) WriteWaveData(ref netMessage);
                netMessage.Send();
            }
        }
        ...
        /// <summary>
        ///     Length of event, if this starts not by using <see cref="TriggerCondition.OnDayBegin" /> or
        ///     <see cref="TriggerCondition.OnNightBegin" />.
        ...
        ///     Event cooldown saves locally per world.
        ...
        ///     If you want start your event only by using item/etc. left there <see cref="TriggerCondition.Both" /> and override
        ///     <see cref="WorldEvent.Chance" /> => 0
        /// </summary>
        ...
        /// </summary>
        public bool IsStarted => started && (Type == InvasionType.Invasion || TimeLeft > 0);
        ...
        ///     To use mobs from others mods use
        ///     <code>
        ...
        public IDictionary<int, Tuple<float, int>> GetListForCurWave
        {
            get
            {
                ...
                if (InvasionList.ContainsKey(Main.invasionProgressWave))
                    foreach (Tuple<int, float, int> it in InvasionList[Main.invasionProgressWave])
