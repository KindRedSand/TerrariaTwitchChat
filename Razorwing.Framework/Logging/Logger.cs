...
using TwitchChat.Razorwing.Framework.Threading;
using System.Linq;

namespace TwitchChat.Razorwing.Framework.Logging
{
    /// <summary>
    ...
    public class Logger
    {
        ...
        public static Storage Storage
        {
            ...
            set
            {
                storage = value; //?? throw new ArgumentNullException(nameof(value)); //Mono don't support exception throwing
        ...
        public static Logger GetLogger(string name)
        {
            lock (static_sync_lock)
            {
                ...
                {
                    LoggingTarget target = LoggingTarget.Debug;
