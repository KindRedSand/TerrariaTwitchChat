...
namespace TwitchChat.Razorwing.Framework.Platform
{
    public static class FileSafety
    {
        ...
        //                        return FileType.Zip;
        //#if P2P
        //                    case "TwitchChat.RazorwingGLmagnet":
        //                        return FileType.TwitchChat.RazorwingGLMagnet;
        //#endif
        //                    case "osc":
        //                        return FileType.TwitchChat.RazorwingGLM; //TwitchChat.RazorwingGL!stream
        //                    case "ogg":
        //                    case "mp3":
        ...
        {
            string directory = Path.Combine(Path.GetTempPath(), @"TwitchChat.RazorwingGL!");
